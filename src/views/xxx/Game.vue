  ...
  export default {
    ...
    methods: {
      ...
      nextPlayer() {
        ...
        //最後一位玩家
        if(this.myCastleID == Object.keys(this.currentPlayer).length){
          this.currentPlayer[1] = true;
        }else{
          this.currentPlayer[parseInt(this.myCastleID)+1] = true;
        }
    ...
    computed: {
      /*myCastleID() {
        //分配 players 的城堡顏色
        let castleID;
        for(let [playerID,playerData] of Object.entries(this.players)){
          if(this.socketID==playerData.playerID){
            castleID = playerID;
            break;
          }
      ...
      myCard() {
        /*let myCard;
        for(let playerData of Object.entries(this.players)){
          playerData = {...playerData[1]};
          if(this.socketID==playerData.playerID){
            myCard = playerData.myCard;
            break;
          }
        }*/
